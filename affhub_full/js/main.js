(function () {
  ...
  var Raiting = function () {
    ...
    return {
      ...
      init: function init() {
        Raiting.createTableRaiting(rainingTable);
      }
    };
  }();
  ...
  var Events = function () {
    ...
    var sliderEvents = $('.js-slider-event');
    var overlay = $(".js-overlay");
    var popupEvent = $(".js-event-popup");
    var btnShowPopup = $(".js-show-popup");
    var contentPopupFormReg = $('.popup-meetup__content');
    var contentPopupFormThanks = $('.popup-meetup__desc');
    var inputForm = $('.js-input');
    var formThanks = $('#popup_thanks');
    var inputLocation = $('.js-input-location');
    return {
      initSliderNextEvents: function initSliderNextEvents() {
        sliderEvents.slick({
          infinite: false,
          speed: 500,
          cssEase: "linear",
      ...
      initPopupNextEvents: function initPopupNextEvents() {
        btnShowPopup.click(function (e) {
          e.preventDefault();

          var _this = $(this);

          var parent = _this.parent('.next-item');

          var dateEvent = parent.find('.js-date').text();
          var placeEvent = parent.find('.js-place').text();
          contentPopupFormReg.prepend(Events.createTitlePopupFormReg(dateEvent, placeEvent));
          contentPopupFormThanks.prepend(Events.createTitlePopupFormThanks(dateEvent, placeEvent));
          var target = $(_this.data("target"));

          var location = _this.data("location");

          inputLocation.val(location);
          $('.popup-meetup__form').show();
          contentPopupFormReg.show();
          formThanks.hide();
        ...
        $(".js-close, .js-overlay").click(function (e) {
          e.preventDefault();
          $('.js-title-popup').html(' ');
          inputForm.val(' ').removeClass('active');
          $(".form_error").html(' ');
      ...
      createTitlePopupFormReg: function createTitlePopupFormReg(date, place) {
        var titlePopupFormReg = "<p class=\"popup-meetup__ttl js-title-popup\">\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F \u043D\u0430&nbsp;\u0441\u0445\u043E\u0434\u043A\u0443 Affhub ".concat(place, ",<br/> <span class=\"date\">").concat(date, "</span></p>");
        return titlePopupFormReg;
      },
      createTitlePopupFormThanks: function createTitlePopupFormThanks(date, place) {
        var titlePopupFormThanks = "<p class=\"popup-meetup__title js-title-popup\">\u0421\u043F\u0430\u0441\u0438\u0431\u043E!<br> \u0414\u043E \u0432\u0441\u0442\u0440\u0435\u0447\u0438 ".concat(place, " <span class=\"date\">").concat(date, "</span></p>");
        return titlePopupFormThanks;
      },
      submitEventForm: function submitEventForm() {
        $('.popup-meetup__form').submit(function (e) {
          e.preventDefault();
          contentPopupFormReg.hide();
          formThanks.show();
        });
      },
      init: function init() {
        Events.initSliderNextEvents();
        Events.initPopupNextEvents();
