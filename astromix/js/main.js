...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _global_layout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./global/layout */ "./src/js/global/layout.js");
...
/* harmony import */ var _modules_Controls__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Controls */ "./src/js/modules/Controls.js");
...
$(function () {
  ...
  _modules_Tabs__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _modules_Sliders__WEBPACK_IMPORTED_MODULE_3__["default"].init();
  _modules_Controls__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  _modules_Menu__WEBPACK_IMPORTED_MODULE_5__["default"].init();
  _global_layout__WEBPACK_IMPORTED_MODULE_0__["default"].layoutHandler({
    onInit: function onInit(layout) {
      if (layout.WIN_WIDTH < 901) {
        _modules_Sliders__WEBPACK_IMPORTED_MODULE_3__["default"].initPriceSlider();
      }
    },
    afterResize: function afterResize(layout) {
      if (layout.WIN_WIDTH >= 901) {
        _modules_Sliders__WEBPACK_IMPORTED_MODULE_3__["default"].destroyPriceSlider();
      } else {
        _modules_Sliders__WEBPACK_IMPORTED_MODULE_3__["default"].initPriceSlider();
      }
    }
  ...
  return {
    showMobileMenu: function showMobileMenu() {
      burgerMenu.click(function (e) {
        ...
        blockForHide.toggleClass('hideBlock');
    ...
    scrollToTarget: function scrollToTarget() {
      linkToTarget.click(function (e) {
        ...
        blockForHide.removeClass('hideBlock');
        $("html, body").animate({
          scrollTop: top - 15
        }, 800);
      });
...
var Sliders = function () {
  ...
  var celebritiesSlider = $(".js-celebrities-slider");
  var reviewsSlider = $(".js-reviews-slider");
  var priceSlider = $('.js-price-slider');
  var isPriceSlider = false;
  return {
    initCelebritiesSlider: function initCelebritiesSlider() {
      celebritiesSlider.slick({
        slidesToShow: 4,
        slidesToScroll: 4,
        prevArrow: '<button class="prev"><i class="fico fico-arrowSlider"></i></button>',
        nextArrow: '<button class="next"><i class="fico fico-arrowSlider"></i></button>',
        dots: true,
    ...
    destroyPriceSlider: function destroyPriceSlider() {
      if (isPriceSlider) {
        priceSlider.slick("destroy");
        isPriceSlider = false;
      }
    },
    init: function init() {
      Sliders.initCelebritiesSlider();
    ...
    showContent: function showContent() {
      tabs.click(function (e) {
        ...
        if (_this.attr('data-percent')) {
          var widthProgress = _this.data('percent');

          progress.css('width', widthProgress);
        }

        var parent = _this.parents('.js-wrapper-tabs');

        parent.find(tabs).removeClass("active");

        _this.addClass("active");

        parent.find(contentTabs).removeClass("active");
...
module.exports = __webpack_require__(/*! /Users/everuser/Documents/work/Astromix/src/js/main.js */"./src/js/main.js");
