...
var layout = function () {
  ...
  return {
    ...
    layoutHandler: function layoutHandler(settings) {
      if (settings) {
        SETTINGS = _objectSpread({}, SETTINGS, {}, settings);
      }
...
$(function () {
  _modules_Sliders__WEBPACK_IMPORTED_MODULE_2__["default"].init();
...
var Sliders = function () {
  ...
  var integrationSlider = $(".js-integration-slider");
  return {
    initNewsSlider: function initNewsSlider() {
      newsSlider.slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        dots: true,
    ...
    initintegrationSlider: function initintegrationSlider() {
...
module.exports = __webpack_require__(/*! /Users/everuser/Documents/accurella/src/js/main.js */"./src/js/main.js");
